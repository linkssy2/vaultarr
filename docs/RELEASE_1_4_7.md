# Vaultarr 1.4.7 — Live Library Synchronization
...
Restart the container and hard-refresh the browser after upgrading so the 1.4.7 JavaScript bundle is loaded.
