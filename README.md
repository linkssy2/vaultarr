...
> Current release: **Vaultarr 1.4.5 — Universal Search & Add**
...
Vaultarr 1.4.5 simplifies the day-to-day experience around one goal: add a game and let Vaultarr prepare the museum record. Standard Mode shows only the essential collection pages, while technical provider, cache, and diagnostic tools remain available through **Advanced Mode** in Settings.
