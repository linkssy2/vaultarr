...
def get_collection_experience():
    ...
    badges = [
        ...
        _badge('first_preserved', 'First Preservation', 'Complete your first preservation-ready game.', '🛡', complete_games, 1, 'bronze', '/museum?attention=1'),
        _badge('archive_apprentice', 'Archive Apprentice', 'Preserve 10 games.', '🛡', complete_games, 10, 'bronze', '/museum?attention=1'),
